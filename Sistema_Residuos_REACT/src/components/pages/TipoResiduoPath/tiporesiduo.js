...
import AdminTipoResiduos from "../Admin/TipoResiduos/AdminTipoResiduos";
import ClienteTipoResiduos from "../Cliente/TipoResiduos/ClienteTipoResiduos";
...
const Mapa = () => {
    ...
    useEffect(() => {
      ...
      return (
        <div>
            {isAdmin ? <AdminTipoResiduos/> : <ClienteTipoResiduos/>}
        </div>
      );
};
