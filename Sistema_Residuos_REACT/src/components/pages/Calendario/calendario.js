...
const Calendario = () => {
    ...
    const dataSource = listaCalendario && listaCalendario.map(item => [
        ...
        { name: item.diaSemana },
        {
            botoes: [
                ...
                {
                    botao: <button onClick={() => ExcluirCalendario(item.calendarioColetaId)} className="btn btn-sm btn-danger" type="button">Excluir</button>
                }
            ]
        }
    ]);
    ...
    const tileContent = ({ date, view }) => {
        if (view === 'month') {
            ...
            if (coleta) {
                return <div className="coleta-content">Coleta às {coleta.horario}</div>;
            }
        }
        return null;
    };
    ...
    return (
        <div className="calendar-page-background"> {/* Classe para o fundo da página */}
            <div className="calendar-table-container"> {/* Novo contêiner flex */}
                ...
                <div className="table-container"> {/* Tabela de cadastro */}
                    ...
                    <div style={{ display: "flex" }}>
                        ...
                        <button onClick={NovoCalendario} type="button" style={{ marginLeft: "5px" }} className="btn-primary">Novo Calendário</button>
                    </div>
...
//     // const tileClassName = ({ date, view }) => {
//     //     if (view === 'month' && isColetaDay(date)) {
//     //         return 'coleta-date';
//     //     }
//     //     return null;
//     // };
...
//                                     type="time" 
//                                     id="horario" 
//                                     step="1" //Adiciona suporte a segundos 
//                                     value={calendario.horario || ""}
//                                     onChange= {(e) =>{handleChange(e, e.target.value)}} 
//                                     className = "form-control">
//                                     </input>                                    
